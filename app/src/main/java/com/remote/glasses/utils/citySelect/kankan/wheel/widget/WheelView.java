...
package com.remote.glasses.utils.citySelect.kankan.wheel.widget;
...
import com.remote.glasses.utils.citySelect.kankan.wheel.widget.adapter.AbstractWheelTextAdapter;
import com.remote.glasses.utils.citySelect.kankan.wheel.widget.adapter.ArrayWheelAdapter;
import com.remote.glasses.utils.citySelect.kankan.wheel.widget.adapter.WheelViewAdapter;
...
//			0xcfE9E9E9, 0x3fE9E9E9 };
	...
	private int[] SHADOWS_COLORS = new int[] { R.color.gray,
			R.color.white, R.color.gray };
	...
	public void notifyChangingListeners(int oldValue, int newValue) {
		if (viewAdapter instanceof ArrayWheelAdapter) {
			...
			// 恢复未选中字体的颜色和大小
			TextView textView = textAdapter.getTextViewByIndex(oldValue);
			if (textView != null) {
			...
			// 设置选中的字体和颜色
			 textView = textAdapter.getTextViewByIndex(newValue);
			if (textView != null) {
...
//			recycle.getItem().findViewById(getViewAdapter())
		}
	}
