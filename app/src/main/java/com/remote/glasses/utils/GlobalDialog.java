...
public class GlobalDialog extends Dialog {
    ...
    private void initViews() {
        ...
        model = (TextView) findViewById(R.id.dialog_model);
        color = (TextView) findViewById(R.id.dialog_color);
        goodPackage = (TextView) findViewById(R.id.dialog_package);
        amount = (TextView) findViewById(R.id.dialog_amount);
        fee = (TextView) findViewById(R.id.dialog_fee);
        ratefee = (TextView) findViewById(R.id.dialog_ratefee);
    ...
    public TextView getGoodPackage() {
        return goodPackage;
    }


    public TextView getRatefee() {
        return ratefee;
    }
