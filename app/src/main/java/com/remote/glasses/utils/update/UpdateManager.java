package com.remote.glasses.utils.update;
...
//			Toast.makeText(mContext, R.string.soft_update_no, Toast.LENGTH_LONG).show();//已经是最新版本
	...
	private double getVersionCode(Context context)
	{
		...
		try
		{
			PackageInfo pinfo = context.getPackageManager().getPackageInfo("com.future.mytour", PackageManager.GET_CONFIGURATIONS);
		...
		public void run()
		{
			try
			{
				...
				if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
				{
					...
					File apkFile = new File(mSavePath, mHashMap.get("describe"));
